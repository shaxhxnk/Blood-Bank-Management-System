<nav class="navbar navbar-expand-sm navbar-light bg-light sticky-top">
	<div class="container">
		...
		<ul class="navbar-nav ml-auto">
			...
			<li class="nav-item">
				<a class="nav-link btn btn-light" href="abs.php">Check Avalibility</a>
            </li>
            <li class="nav-item">
                <a href="hprofile.php?id=<?php echo $_SESSION['hid']; ?>" class="nav-link btn btn-light"><?php echo $_SESSION['hname']; ?></a>
            </li>
            <li class="nav-item">
                <a class="nav-link btn  btn-sm btn-light" href="logout.php">Logout</a>
            </li>
        </ul>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a href="rprofile.php?id=<?php echo $_SESSION['rid']; ?>" class="nav-link btn btn-light" href="#"><img src="image/user.png" width="15" height="15" class="rounded-circle"> <?php echo ' '.$_SESSION['rname']; ?></a>
            </li>
            <li class="nav-item">
                <a class="nav-link btn btn-danger btn-sm btn-light" href="logout.php">Logout</a> 
            </li>
        </ul>
