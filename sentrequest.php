...
<body>
	...
	<table class="table table-responsive table-striped table-hover rounded mb-5 mar">
		<tr class="trtitle "><th colspan="8" class="title">Sent requests</th></tr>
		<tr class="trr">
			<th>#</th>
			<th>Name</th>
			<th>Email</th>
		    ...
		    <div>
                ...
                }else echo '<b style="color:white;background-color:red;padding:10px;">You have not requested yet. </b>';
            }
            ?>
            </div>
