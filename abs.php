...
<body>
    ...
    <div class="container cont topcont">
        ...
        <div>
                ...
                }else echo '<b style="color:white;background-color:red;padding:10px;">Not Avaliable</b>';
            }
            ?>
            </div>
        <div class="row col-lg-8 col-md-8 col-sm-12 mb-3">
            ...
            <label class="font-weight-bolder">Select Blood Group:</label>
               ...
               <select name="search" class="form-control" style="width:500px; ">
               ...
               <a href="abs.php" class="btn btn-info btn-light mr-4"> Reset</a>
               <input type="submit" name="submit" class="btn btnsub btn-info" value="Search">
           </form>
        </div>

        <table class="table table-responsive table-striped rounded mb-5  mar">
            <tr class="trtitle"><th colspan="7" class="title">Available Blood Samples</th></tr>
            <tr class="trr">
                <th>#</th>
                <th>Hospital Name</th>
                <th>Hospital City</th>
        ...
        <?php while($row = mysqli_fetch_array($result)) { ?>
            ...
            <tr>
                ...
                <td><a href="javascript:void(0);" class="btn btnreq btn-info hospital">Request Sample</a></td>
